...
public class LocatorStats {
  ...
  private static final String KNOWN_LOCATORS = ConfigurationProperties.LOCATORS; // gauge
  ...
  private void initializeStats(StatisticsFactory factory) {
    ...
    type = factory.createType(statName, statDescription, new StatisticDescriptor[] {
        factory.createIntGauge(KNOWN_LOCATORS, "Number of locators known to this locator", ConfigurationProperties.LOCATORS),
   ...
   */
  public LocatorStats(StatisticsFactory factory) {
