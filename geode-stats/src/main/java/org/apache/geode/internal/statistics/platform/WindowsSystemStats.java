...
public class WindowsSystemStats {
  ...
  private void initializeStats(StatisticsFactory factory) {
    myType = factory.createType("WindowsSystemStats", "Statistics on a Microsoft Windows machine.",
        new StatisticDescriptor[] {
            factory.createIntGauge("committedMemoryInUse",
                "This represents the percentage of available virtual memory in use. This is an instantaneous value, not an average.",
                "%"),
            factory.createIntGauge("events",
                ...
                "items"),
            factory.createIntCounter("interrupts",
                ...
                "operations", false),
            factory.createIntGauge("mutexes",
            ...
            factory.createIntGauge("processes",
                ...
                "processes"),
            factory.createIntGauge("processorQueueLength",
                ...
                "threads"),
            factory.createIntGauge("registryQuotaInUse",
                "The percentage of the Total Registry Quota Allowed currently in use by the system.",
                "%"),
            factory.createIntGauge("sharedMemorySections",
                ...
                "items"),
            factory.createIntGauge("semaphores",
                ...
                "items"),
            factory.createIntGauge("threads",
                ...
                "threads"),
            factory.createIntCounter("dgramsReceived",
                "The number of datagrams received on the VM's machine.", "datagrams/sec"),
            factory.createIntCounter("dgramsNoPort",
            ...
            factory.createLongGauge("availableMemory",
                ...
                "bytes", true),
            factory.createLongCounter("cacheFaults",
                ...
                "operations", false),
            factory.createLongGauge("cacheSize",
                ...
                "bytes"),
            factory.createLongGauge("cacheSizePeak",
            ...
            factory.createLongGauge("committedMemory",
                ...
                "bytes"),
            factory.createLongGauge("committedMemoryLimit",
            ...
            factory.createLongCounter("contextSwitches",
                ...
                "operations", false),
            factory.createLongCounter("demandZeroFaults",
            ...
            factory.createLongCounter("pageReads",
                ...
                "operations", false),
            factory.createLongCounter("pages",
                ...
                "pages", false),
            factory.createLongCounter("pageWrites",
                ...
                "operations", false),
            factory.createLongCounter("pagesInput",
            ...
            factory.createDoubleGauge("cpuActive",
                ...
                "%"),
            factory.createDoubleGauge("cpuIdle",
                "The percentage of time the machine's processors spent idle.", "%", true),
            factory.createDoubleGauge("cpuInterrupt",
                ...
                "%"),
            factory.createDoubleGauge("cpuSystem",
                ...
                "%"),
            factory.createDoubleGauge("cpuUser",
  ...
  public WindowsSystemStats(StatisticsFactory factory) {
