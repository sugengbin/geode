...
public class GetCQStats extends BaseCQCommand {
  ...
  public void cmdExecute(final Message clientMessage, final ServerConnection serverConnection,
    ...
    serverConnection.setAsTrue(Command.REQUIRES_RESPONSE);
    serverConnection.setAsTrue(Command.REQUIRES_CHUNKED_RESPONSE);

    final boolean isDebugEnabled = BaseCommand.logger.isDebugEnabled();
    if (isDebugEnabled) {
      BaseCommand.logger.debug("{}: Received close all client CQs request from {}", serverConnection.getName(),
    ...
    if (isDebugEnabled) {
      BaseCommand.logger.debug("{}: Received close CQ request from {} cqName: {}", serverConnection.getName(),
