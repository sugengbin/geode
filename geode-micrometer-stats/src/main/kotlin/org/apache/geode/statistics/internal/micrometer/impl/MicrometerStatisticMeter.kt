...
abstract class MicrometerStatisticMeter(
    ...
    abstract fun register(meterRegistry: MeterRegistry, tags: Iterable<Tag> = emptyList())
...
data class GaugeStatisticMeter(val meterName: String,
    ...
    override fun register(meterRegistry: MeterRegistry, tags: Iterable<Tag>) {
        meter = Gauge.builder(meterName, backingValue) { backingValue.toDouble() }
                .description(meterDescription).baseUnit(meterUnit).tags(tags).register(meterRegistry)
    }
...
data class TimerStatisticMeter(val meterName: String,
    ...
    override fun register(meterRegistry: MeterRegistry, tags: Iterable<Tag>) {
        meter = Timer.builder(meterName)
                .description(meterDescription).tags(tags).register(meterRegistry)
    }
