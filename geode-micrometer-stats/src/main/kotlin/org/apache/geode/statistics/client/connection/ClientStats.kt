...
class ClientStats(poolName:String) : MicrometerMeterGroup("ClientConnectionStats-$poolName") {
    ...
    val operationGetTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationPutTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationDestroyTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationRegionDestroyTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationClearTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationContainsKeysTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationKeySetTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationCommitTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationRollbackTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationGetEntryTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationTxSynchronizationTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationTxFailoverTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationSizeTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationInvalidateTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationRegisterInterestTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationUnregisterInterestTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationQueryTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationCreateCQTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationStopCQTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationCloseCQTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationGetDurableCQsTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationReadyForEventsTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationGatewayBatchTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationMakePrimaryTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationPrimaryAckTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationCloseConnectionTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationPingTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationRegisterInstantiatorsTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationRegisterDataSerializersTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationPutAllTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationRemoveAllTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationGetAllTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationExecuteFunctionTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationAsyncExecuteFunctionTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationGetClientPRMetadataTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationGetClientPartitionAttributesTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationGetPDXTypeByIdTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationGetPDXIdForTypeTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val operationAddPdxTypeTimer = TimerStatisticMeter("connection.operation.timer",
    ...
    val receivedBytesMeter = CounterStatisticMeter("connection.received.bytes",
            "Total number of bytes received (as responses) from server over a client-to-server connection.", unit = "bytes")
    val sentBytesMeter = CounterStatisticMeter("connection.sent.bytes",
            "Total number of bytes sent to server over a client-to-server connection.", unit = "bytes")
    ...
    val messagesReceivedBytesMeter = GaugeStatisticMeter("connection.received.messages.bytes",
            "Current number of bytes consumed by messages being received or processed over a client-to-server connection.", unit = "bytes")
