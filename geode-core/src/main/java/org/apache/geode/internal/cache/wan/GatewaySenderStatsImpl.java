...
public class GatewaySenderStatsImpl implements GatewaySenderStats, GFSStatsImplementor {
  ...
  public void initializeStats(StatisticsFactory factory) {
    type = factory.createType(typeName, "Stats for activity in the GatewaySender",
        new StatisticDescriptor[]{
            ...
            factory.createIntGauge(EVENTS_PROCESSED_BY_PQRM,
                ...
                "operations", false),
            factory.createIntGauge(TMP_EVENT_QUEUE_SIZE, "Size of the temporary events.",
                "operations",
                false),
    ...
    eventsReceivedId = type.nameToId(GatewaySenderStatsImpl.EVENTS_RECEIVED);
