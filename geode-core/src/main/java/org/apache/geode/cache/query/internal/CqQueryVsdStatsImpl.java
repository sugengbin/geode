 ...
 * @since GemFire 5.5
 */
public abstract class CqQueryVsdStatsImpl implements CqQueryVsdStats, GFSStatsImplementor {
   ...
   */
  public CqQueryVsdStatsImpl(StatisticsFactory factory, String name) {
