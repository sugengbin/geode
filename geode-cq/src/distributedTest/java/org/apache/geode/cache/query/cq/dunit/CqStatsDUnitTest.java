...
public class CqStatsDUnitTest extends JUnit4CacheTestCase {
  ...
  public void testCQStatistics() throws Exception {
    ...
    // validate CQs.
    cqDUnitTest.validateCQ(client, "testCQStatistics_0", /* resultSize: */ CqQueryDUnitTest.noTest,
        /* creates: */ 100, /* updates: */ 100, /* deletes; */ 0, /* queryInserts: */ 100,
        /* queryUpdates: */ 100, /* queryDeletes: */ 0, /* totalEvents: */ 200);
    ...
    cqDUnitTest.validateCQ(client, "testCQStatistics_0", /* resultSize: */ CqQueryDUnitTest.noTest,
        /* creates: */100, /* updates: */ 100, /* deletes; */ 100, /* queryInserts: */ 100,
        /* queryUpdates: */ 100, /* queryDeletes: */ 100, /* totalEvents: */ 300);
  ...
  public void testCQServiceStatistics() throws Exception {
    ...
    // validate CQs.
    cqDUnitTest.validateCQ(client1, cqName, /* resultSize: */ CqQueryDUnitTest.noTest,
    ...
    validateCQServiceStats(server, 22, 0, 1, 21, CqQueryDUnitTest.noTest, CqQueryDUnitTest.noTest,
        1);
